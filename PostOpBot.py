...
st.sidebar.markdown(
    ...
    <div class="footer">3) Shenoi, R. S., Rajguru, J. G., Parate, S. R., Ingole, P. D., Khandaitkar, S. R., & Karmarkar, J. S. (2021). Compliance of postoperative instructions following the surgical extraction of impacted lower third molars. Indian Journal of Dental Research, 32(1), 87-91.</div>
    """,
    unsafe_allow_html=True
)
